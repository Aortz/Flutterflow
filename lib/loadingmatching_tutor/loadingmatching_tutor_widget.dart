...
class LoadingmatchingTutorWidget extends StatefulWidget {
  LoadingmatchingTutorWidget({Key key}) : super(key: key);

  @override
  _LoadingmatchingTutorWidgetState createState() =>
      _LoadingmatchingTutorWidgetState();
}

class _LoadingmatchingTutorWidgetState
    extends State<LoadingmatchingTutorWidget> {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Finding a suitable student, hang on!',
