...
class LessonDetailStudentWidget extends StatefulWidget {
  ...
  @override
  _LessonDetailStudentWidgetState createState() =>
      _LessonDetailStudentWidgetState();
}

class _LessonDetailStudentWidgetState extends State<LessonDetailStudentWidget> {
              ...
              child: IconButton(
                onPressed: () async {
                  await Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => HomePageStudentWidget(),
                    ),
                  );
                },
                icon: Icon(
