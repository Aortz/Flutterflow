...
class RegistrationStudentWidget extends StatefulWidget {
  RegistrationStudentWidget({Key key}) : super(key: key);

  @override
  _RegistrationStudentWidgetState createState() =>
      _RegistrationStudentWidgetState();
}
